...
const postcardRedirects = postcardYears.flatMap((year) =>
  postcardMonths.flatMap((month, i) => {
...
export function getRedirects(): Redirect[] {
  return [
    ...
    // contraption.co Ghost legacy: section slug redirects
    ...
    { source: '/updates/:slug', destination: '/:slug', permanent: true },
    { source: '/news/:slug', destination: '/:slug', permanent: true },
    { source: '/policies/:slug', destination: '/:slug', permanent: true },
    // contraption.co Ghost legacy: section index pages
    { source: '/essays', destination: '/', permanent: true },
    { source: '/conversations', destination: '/', permanent: true },
    { source: '/updates', destination: '/', permanent: true },
    { source: '/news', destination: '/', permanent: true },
    // contraption.co Ghost legacy: misc pages
