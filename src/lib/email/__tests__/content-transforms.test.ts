...
describe('styleContentLinks', () => {
  ...
  it('styles links with the Tidbits primary', () => {
    expect(
      styleContentLinks('<a href="https://example.com">link</a>', 'tidbits')
    ).toBe(
      '<a style="color: #3B3834; text-decoration: underline; text-decoration-color: #8c4d87; text-underline-offset: 2px;" href="https://example.com">link</a>'
    )
  })
