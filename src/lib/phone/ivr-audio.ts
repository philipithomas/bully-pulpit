...
export const PHONE_IVR_SPEECH_MODEL_ID = 'xai/grok-tts'
export const PHONE_IVR_SPEECH_VOICE = 'iris'
export const PHONE_IVR_SPEECH_FORMAT = 'wav'
export const PHONE_IVR_SPEECH_SPEED = 1.35
...
export const PHONE_IVR_FALLBACK_PROMPTS = {
  ...
  bellMenu:
    'Press 1 to leave a voicemail. Bell AI calls are transcribed and emailed to the site administrators. Press 3 to talk to Bell AI.',
  ...
  menuWithBell:
    'Press 1 to leave a voicemail. Press 2 to subscribe to recurring new-post texts from philipithomas.com. Bell AI calls are transcribed and emailed to the site administrators. Press 3 to talk to Bell AI. A new or reactivated text subscription includes one Bell contact-card multimedia message. Frequency varies. Message and data rates may apply. Text STOP to unsubscribe or HELP for help.',
  subscribeFailed:
...
/** Static Iris WAV for a fixed prompt or a dynamic prompt's outage fallback. */
