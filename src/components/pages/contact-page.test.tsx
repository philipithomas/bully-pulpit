...
import { SmsConsentSection } from '@/components/pages/contact-page'
import { SMS_SUBSCRIBE_CONFIRMATION } from '@/lib/phone/sms-subscription-copy'

describe('SmsConsentSection', () => {
