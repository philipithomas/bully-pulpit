...
description: "Open-sourcing Toolbox, a framework for Mac-based home web servers"
publishedAt: "2025-04-11"
coverImage: "/images/covers/how-to-host-web-apps-on-a-mac-mini-cover.jpg"
coverImageAlt: "Coffee Movement in San Francisco's Richmond district"
---

A few weeks ago, I published [A mini data center](/a-mini-data-center) describing my home Mac Mini that hosts web applications, including this blog.
...
-   A local [Metabase](https://www.metabase.com/) instance would need about 8 GB of RAM.[\[2\]](#fn2)
...
1.  Internet costs $40 per month, which remained unchanged. The Mac Mini’s power usage has not been noticed in the home electricity bill. I reused an existing UptimeRobot account, though the paid plan is $8 per month. Papertrail is on the free plan. Other minor expenses may exist. [↩︎](#fnref1)
    
2.  Metabase was a frequent part of my workflows in the past. While installing it on the Mac Mini, I noticed that AI text-to-SQL support still had not arrived, so I set it aside. Let me know if you recommend an alternative. [↩︎](#fnref2)
