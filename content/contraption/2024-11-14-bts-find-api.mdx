...
We recently released a Search API for [Find AI](/find-ai), and announced [its integration with Clay.com](https://university.clay.com/docs/find-ai-integration-overview).
...
Mintlify’s docs became our main resource. They were clean, easy to navigate, and SEO-friendly, thanks to an [installation via Cloudflare Workers](https://www.mintlify.com/docs/advanced/subpath/cloudflare).
...
The original Find AI search product and API are no longer active. The video and this post remain a record of how we built and introduced the API.
